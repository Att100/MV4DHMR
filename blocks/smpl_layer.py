...
class SMPL_Layer(nn.Module):
    ...
    def __init__(self, 
        ...
        self.bm_x = smplx.create(SMPLX_DIR, type, gender=gender, use_pca=False, flat_hand_mean=True, num_betas=num_betas)

        # Primary keypoint - root
        self.joint_names = eval(f"utils.get_smplx_joint_names")()
    ...
    def forward(self,
        ...
        if self.type == "smplx":
            ...
            kwargs_pose['body_pose'] = pose[:,1:].flatten(1)
