...
class Loss(torch.nn.Module):
    def __init__(self, alphas: dict=None, *args, **kwargs):
        super().__init__()
    ...
    def forward(self, y_hat, y, epoch=None, img_size=None):
        ...
        # total
        total_loss = self.alphas['alpha_bce'] * bce +\
                     self.alphas['alpha_offset'] * reg_offset +\
                     self.alphas['alpha_rotmat'] * reg_rotmat +\
                     self.alphas['alpha_shape'] * reg_shape +\
                     self.alphas['alpha_dist'] * reg_dist +\
                     self.alphas['alpha_transl'] * reg_transl +\
                     self.alphas['alpha_j3d'] * reg_j3d +\
                     self.alphas['alpha_v3d'] * reg_v3d
        if epoch >= self.alphas['start_2d_epoch'] :
            total_loss += self.alphas['alpha_j2d'] * reg_j2d +\
                          self.alphas['alpha_v2d'] * reg_v2d
